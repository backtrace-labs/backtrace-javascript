...
| Option                | Values                                             | Default              | Description                                                                                                                 |
| --------------------- | -------------------------------------------------- | -------------------- | --------------------------------------------------------------------------------------------------------------------------- |
| `blockClass`          | `string`/`RegExp`                                  | `'rr-block'`         | Blocks elements with this class.                                                                                            |
| `blockSelector`       | `string`                                           | `undefined`          | Blocks elements matching this selector.                                                                                     |
| `ignoreClass`         | `string`                                           | `'rr-ignore'`        | Ignores elements with this class.                                                                                           |
...
| `maskTextClass`       | `string`/`RegExp`                                  | `'rr-mask'`          | Masks elements with this class.                                                                                             |
| `maskTextSelector`    | `string`                                           | `undefined`          | Masks elements matching this selector.                                                                                      |
| `maskAllInputs`       | `boolean`                                          | `false`              | If `true`, will mask all inputs.                                                                                            |
