...
The [@backtrace/react](#) SDK connects your React application to Backtrace. The basic integration is quick and easy,
...
The `@backtrace/react` SDK offers an Error Boundary that will handle errors during rendering, send the error and
